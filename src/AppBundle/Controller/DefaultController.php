...
class DefaultController extends Controller
{
    ...
    /**
     * @Route("/home/find/{column}/{condition}/{page}/", defaults={"page" = 1, "column" = "group", "condition" = "null"}, name="homepage_with_conditions")
     */
    public function indexConditionAction(Request $request, $page = 1, $column = "group", $condition = "null" )
    {
        $data = [];
